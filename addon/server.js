  ...
  <div class="card">
    ...
    <div id="streamersContainer" class="config-panel">
      ...
      <div class="option-grid">
        ...
        <label class="option-item">
          <input type="checkbox" id="streamerMax" value="max">
          <span>Max</span>
        </label>

        <label class="option-item">
          <input type="checkbox" id="streamerPrime" value="prime">
          <span>Prime Video</span>
        </label>

        <label class="option-item">
          <input type="checkbox" id="streamerDisney" value="disney">
          <span>Disney+</span>
        </label>

        <label class="option-item">
          <input type="checkbox" id="streamerApple" value="apple">
          <span>Apple TV+</span>
        </label>
