...
function chooseWorldLogoCandidate(candidates, config = null, matchedKey = "") {
  ...
  if (preferredCountry) {
    ...
    if (sameCountry.length) {
      pool = sameCountry;
    } else if (countries.length > 1 && String(matchedKey || "").length <= 6) {
...
<svg xmlns="http://www.w3.org/2000/svg" width="600" height="900" viewBox="0 0 600 900">
  ...
  <image href="${dataUri}" x="135" y="325" width="330" height="250" preserveAspectRatio="xMidYMid meet"/>
</svg>`;
